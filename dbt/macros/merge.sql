{#-
    incremental strategy with multiple columns is currently not working, as the
    'database-name' is not ignored in "DELETE ... WHERE" statements.
    i.e. "main.core.f_laps.race_id" results in "Referenced table 'main' not found!"

    In line 70 we instead use an alias 't' to circumvent this issue.
#}
